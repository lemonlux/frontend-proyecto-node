...
export const verifyConfirmationCode = async (formData) =>{
    return APIUser.post('/users/verify', formData).then((res)=> res).catch((error)=> error)
}
...
export const resendConfirmationCode = async (formData) =>{
    return APIUser.post('/users/resend', formData).then((res)=> res).catch((error)=> error)
}
...
export const autoLoginUser = async (formData) =>{
    return APIUser.post('users/login/autoLogin', formData).then((res)=> res).catch((error)=> error)
}
...
export const regularLoginUser = async (formData) =>{
    return APIUser.post('users/login', formData).then((res)=> res).catch((error)=> error)
}
...
export const setNewPasswordNoAuth = async (formData) =>{
    return APIUser.patch('/users/password/setNewPassword', formData).then((res)=> res).catch((error)=> error)
}
